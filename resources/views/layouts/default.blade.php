...
<!--begin::Head-->
    <head>
        ...
        <link href="{{WEBSITE_CSS_URL}}themes/layout/brand/light.css" rel="stylesheet" type="text/css" />
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable">
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('.fancybox-buttons').magnificPopup({type:'image'});
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center  header-mobile-fixed ">
        ...
        <a href="{{URL('adminpnlx/dashboard')}}">
            <img alt="Logo" src="{{WEBSITE_IMG_URL}}logo-light-w.png" style="width:100px" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
            ...
            <div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto " id="kt_brand">
                    ...
                    <a href="{{URL('adminpnlx/dashboard')}}" class="brand-logo">
                        <img height="50" alt="Logo" src="{{WEBSITE_IMG_URL}}logo.png" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                ...
                <!--end::Brand-->
                <!--begin::Aside Menu-->
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper"> <?php
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4 " data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <ul class="menu-nav ">
                           ...
                           <!--  <li class="menu-item menu-item-submenu {{ in_array($segment3 ,array('service','sub-services')) ? 'menu-item-open' : '' }}"
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li @if($segment3=='service' ) class="menu-item menu-item-active" @else
                                            class="menu-item" @endif aria-haspopup="true">
                                            <a href="{{URL('adminpnlx/service')}}" class="menu-link">
                                       ...
                                       <li @if($segment3=='sub-services')
                                            class="menu-item menu-item-active" @else class="menu-item" @endif
                                            aria-haspopup="true">
                                            <a href="{{URL('adminpnlx/sub-services')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                          ...
                          <!--   <li class="menu-item menu-item-submenu {{ in_array($segment3 ,array('cms-manager')) ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:void(0);" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li @if($segment3=='cms-manager') class="menu-item menu-item-active" @else class="menu-item"  @endif  aria-haspopup="true">
 ...
 -->
                         ...
                         <!--    <li class="menu-item menu-item-submenu {{ in_array($segment3 ,array('links','colors')) ? 'menu-item-open' : '' }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:void(0)" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li @if($segment3=='links' ) class="menu-item menu-item-active" @else
                                            class="menu-item" @endif aria-haspopup="true">
                                            <a href="{{URL('adminpnlx/links')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                                       ...
                                       <li @if($segment3=='colors')
                                            class="menu-item menu-item-active" @else class="menu-item" @endif
                                            aria-haspopup="true">
                                            <a href="{{URL('adminpnlx/colors')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                            ...
                            <li class="menu-item  {{ ($segment3 == 'from_address') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{URL('adminpnlx/from_address')}}" class="menu-link ">
                                    <span class="svg-icon menu-icon">
                                       <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <span class="menu-text">From Address</span>
                                </a>
                            </li>
                            <li class="menu-item  {{ ($segment3 == 'to_address') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{URL('adminpnlx/to_address')}}" class="menu-link ">
                                    <span class="svg-icon menu-icon">
                                       <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <span class="menu-text">To Address</span>
                                </a>
                            </li>
                            <li class="menu-item  {{ ($segment3 == 'invoice') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{URL('adminpnlx/invoice')}}" class="menu-link ">
                                    <span class="svg-icon menu-icon">
                                       <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                            ...
                            <li class="menu-item  {{ ($segment3 == 'creditmis') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{URL('adminpnlx/creditmis/index')}}" class="menu-link ">
                                    <span class="svg-icon menu-icon">
                                       <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <span class="menu-text">Credit MIS</span>
                                </a>
                            </li>
                            
                            
							 <li class="menu-item  {{ ($segment3 == 'reviews') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{URL('adminpnlx/reviews')}}" class="menu-link ">
                                    <span class="svg-icon menu-icon">
                                       <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
							...
							<li class="menu-item  {{ ($segment3 == 'banners') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{URL('adminpnlx/banners')}}" class="menu-link ">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
							...
							<li class="menu-item  {{ ($segment3 == 'blocks') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{URL('adminpnlx/blocks')}}" class="menu-link ">
                                    <span class="svg-icon menu-icon">
                                      <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
							...
							<!-- <li class="menu-item  {{ ($segment3 == 'software-partner') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{URL('adminpnlx/software-partner')}}" class="menu-link ">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <span class="menu-text">Software Partner</span>
                                </a>
                            </li> -->


                            <!-- <li class="menu-item  {{ ($segment3 == 'wedding-location') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{URL('adminpnlx/wedding-location')}}" class="menu-link ">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <span class="menu-text">Wedding Location</span>
                                </a>
                            </li> -->

                            <!-- <li class="menu-item  {{ ($segment3 == 'faq') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{URL('adminpnlx/faq')}}" class="menu-link ">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
							...
							<!-- <li class="menu-item  {{ ($segment3 == 'certificates') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{URL('adminpnlx/certificates')}}" class="menu-link ">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
 ...
 -->
                           <!--  <li class="menu-item menu-item-submenu {{ in_array($segment3 ,array('category')) ? 'menu-item-open' : '' }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
                                                <rect fill="#000000" opacity="0.3" x="5" y="8" width="2" height="8"
                                                    rx="1" />
                                                <path
                                                    ...
                                                    fill="#000000" fill-rule="nonzero" />
                                                <rect fill="#000000" opacity="0.3" x="17" y="8" width="2" height="8"
                                                    rx="1" />
                                                <path
                                ...
                                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                    <a href="#" class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column text-left">
                                            ...
                                            <span
                                                class="text-primary font-weight-bold">{{!empty(Auth::guard('admin')->user()->name[0]) ? strtoupper(Auth::guard('admin')->user()->name) : ""}}</span>
                                        </div>
                                    </a>
                                </div>
                                <!--begin::Dropdown-->
